...
type UpdatePatientInput = any; // TODO: Update when procedure is implemented
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <Input id="id" name="id" required placeholder="Patient ID" />
          </div>
          ...
          <Button
            ...
            className="w-full"
          >
            {updatePatient.isPending ? "Updating Patient..." : "Update Patient"}
          </Button>
        </form>
      </CardContent>
    </Card>
