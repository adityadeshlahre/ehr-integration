/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3ebcf51b7a6d1159100794aaefdf0219)
...
declare namespace Cloudflare {
	interface Env {
		...
		EPIC_CLEINT_ID_PROD: string;
		EPIC_CLIENT_SECRET: string;
		EPIC_TOKEN_URL: string;
		EPIC_AUTH_URL: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "CORS_ORIGIN" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "EPIC_BASE_URL" | "EPIC_CLIENT_ID" | "EPIC_CLEINT_ID_PROD" | "EPIC_CLIENT_SECRET" | "EPIC_TOKEN_URL" | "EPIC_AUTH_URL">> {}
}
